...
const options = {
  legend: {
    display: false, //กล่องบอกว่าสีเส้นข้อมูลในกราฟคืออะไร
  },
  elements: {
    point: {
      radius: 0,
  ...
  tooltips: { //show info when mouse hover
    mode: "index",
    intersect: false,
    callbacks: {
...
function LineGraph({casesType = 'cases',...props}) {
    ...
    return (
      <div className = {props.className}> {/* if data is exist and data length > 0 return Line for handle first render that data not fetch yet*/}
